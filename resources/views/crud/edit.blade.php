                        ...
                        <form action="{{ route('crud.update', $crud->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ old('name', $crud->name) }}" placeholder="Masukkan Nama Anda">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ old('email',$crud->email) }}" placeholder="Masukkan Email Anda">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                    name="phone" value="{{ old('phone', $crud->phone) }}" placeholder="Masukkan Phone Anda">
